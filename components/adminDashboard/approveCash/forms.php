                ...
                <div class="table">
                    <div class="table_section">
                        <table>
                            ...
                            <tbody>
                            <?php
                                    $sql = "Select * from stdforms where usn_number='$usn_number'";
                                    $res = $con->query($sql);
                                    $rw = $res->fetch_object();
                                    for($x=1;$x<=12;$x++){
                                        $name = 'course'.$x;
    ...
    <div class="row">
        <div class="box1">
            ...
            elseif($payment_mode == 'Cash'){?>
                ...
                <div class="feilds">
                    <form action="formscon.php" method="POST">
                    <label class="labeltxt">Accept Payment</label><br><br>
                    <input class="tgl tgl-ios" id="cb2" name="Paid" type="checkbox" required>
