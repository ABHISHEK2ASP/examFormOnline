...
$stmt = $con->prepare("insert into payment_details	(acedemic_year,sem,usn_number,name,email,payment_mode,payment_status,reference_no,amount)
values(?,?,?,?,?,?,?,?,?)");
$stmt->bind_param("sssssssss",$acedemic_year,$sem,$usn_number,$name,$email,$payment_mode,$payment_status,$reference_no,$amount);
$stmt->execute();
